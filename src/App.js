...
import RegionsGridPage from "./pages/RegionsGrid_edit.js";
import RegionPage from "./pages/RegionPage_edit.js";
import RestaurantPage from "./pages/HoReCaPage_edit.js";
import AuthenticatePage from "./pages/AuthenticatePage_edit.js";
import StartPage from './pages/StartPage_edit.js';
import UserPage from './pages/UserPage_edit.js';
import ContactPage from './pages/ContactPage';
import InstructionsPage from './pages/InstructionsPage';
import PrivateLayout from './pages/PrivatePage_edit.js';
import WinefairsPage from './pages/WinefairsPage_edit.js';
